...
import 'package:internship_pakistan/ui/views/week_1/task2_view/w1task2_controller.dart';
import 'package:internship_pakistan/ui/views/week_1/task2_view/w1task2_widget/column_field.dart';

class W1Task2View extends StatelessWidget {
  const W1Task2View({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<W1Task2Controller>(
        init: W1Task2Controller(),
        builder: (controller) {
